 ...
 */
class getAchatsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AchatsRepository' shared autowired service.
     *
     * @return \App\Repository\AchatsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AchatsRepository.php';

        return $container->privates['App\\Repository\\AchatsRepository'] = new \App\Repository\AchatsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
