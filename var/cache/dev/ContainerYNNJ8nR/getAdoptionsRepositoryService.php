 ...
 */
class getAdoptionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdoptionsRepository' shared autowired service.
     *
     * @return \App\Repository\AdoptionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdoptionsRepository.php';

        return $container->privates['App\\Repository\\AdoptionsRepository'] = new \App\Repository\AdoptionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
